...
web build:
 - http://mootools.net/more/1d661712f5615461ffb67bcb94064f4f

packager build:
 - packager build More/Number.Format More/Fx.Reveal More/Mask
...
b.reveal().chain(function(){(function(){b.dissolve();}).delay(c.duration||2000);});}});})();Class.Mutators.Binds=function(a){if(!this.prototype.initialize){this.implement("initialize",function(){});
